...
**Software Developer | Frontend & React Native | AI-Powered Enterprise Solutions**
...
- **Teknofest Electric Vehicle Races** — 1st Place in Software, overall finalist
- **Teknofest Model Rocket Competition** — Real-time data visualization
...
**CS50** (Harvard) · **Frontend Developer** (Meta) · **React Native Developer** (Meta) · **Front End Apps with React** (edX)
